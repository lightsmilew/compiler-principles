...
| 队伍 | 学校 | 备注 |
| --- | --- | --- |
| [不队](https://gitlab.eduxiji.net/educg-group-36290-2935672/T202500000205464-2455) | 剑桥大学 | 2025 年编译系统赛 RISC-V 特等奖|
| [0x676e616c63](https://gitlab.eduxiji.net/educg-group-36290-2935672/T202510614205710-2983) | 电子科技大学 | 2025 年编译系统赛 ARM 特等奖 |
...
| 成员 | 主要负责 |
| --- | --- |
| 成员 A | 前端：词法分析、语法分析、语义分析 |
| 成员 B | 中端：IR 生成、IR 优化 |
| 成员 C | 后端：目标代码生成、寄存器分配、目标代码优化 |
